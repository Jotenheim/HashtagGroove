...
const Spotify = {
  ...
  addTrackToPlaylist: async function(term, songID) {
    const options = {
      url: `https://api.spotify.com/v1/playlists/${terms[term].playlistID}/tracks?uris=spotify:track:${songID}`,
